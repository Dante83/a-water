...
var waveNormalMapMaterialData = {
  ...
  fragmentShader: [
    ...
    'void main(){',
      ...
      'float s01 = texture2D(waveHeightTexture, fModulo1(uv + off.xy)).x;',
      'float s21 = texture2D(waveHeightTexture, fModulo1(uv + off.zy)).x;',
      'float s10 = texture2D(waveHeightTexture, fModulo1(uv + off.yx)).x;',
      'float s12 = texture2D(waveHeightTexture, fModulo1(uv + off.yz)).x;',
