...
ARestlessOcean.Materials.Ocean.waterfallSheetMaterial = {
  uniforms: {
    ...
    fallCorridorA: {value: Array.from({length: 48}, function(){ return new THREE.Vector4(); })},
    fallCorridorB: {value: Array.from({length: 48}, function(){ return new THREE.Vector4(); })},
